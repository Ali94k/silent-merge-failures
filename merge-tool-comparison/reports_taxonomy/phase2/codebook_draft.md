# Codebook Draft — Mechanism Categories for Clean-Merge Semantic Breakages (Phase 2)
...
### `import-pruning-vs-concurrent-usage`
- **name:** Import pruning vs. concurrent use
...
- **exclusion:** If a successor exists under a new name or package → `stale-reference-to-renamed-or-relocated-declaration`. If a same-named declaration remains with a different arity/type/contract → `stale-caller-of-changed-signature`. If only an import line was removed → `import-pruning-vs-concurrent-usage`.
- **anchors:**
...
- **exclusion:** Symbol gone entirely → `stale-reference-to-removed-declaration`. Symbol renamed → `stale-reference-to-renamed-or-relocated-declaration`. Contract change is purely *behavioral* (compiles fine, breaks at runtime) → `changed-behavior-vs-stale-expectation`.
- **anchors:**
...
- **boundary:** vs. `changed-behavior-vs-stale-expectation`: this category breaks statically (binding/typing); that one composes cleanly at the type level and diverges only in runtime semantics.

---

### `changed-behavior-vs-stale-expectation`
- **name:** Runtime-behavior change vs. dependent code
...
| unit_id | category |
|---|---|
| apache_commons-collections__84e70353ad | import-pruning-vs-concurrent-usage |
| ardesco_selenium-standalone-server-plugin__957d978135 | import-pruning-vs-concurrent-usage |
| atam4j_atam4j__71fcecb071 | import-pruning-vs-concurrent-usage |
...
| cternes_openkeepass__bb53512ab2 | import-pruning-vs-concurrent-usage |
| datastax_java-driver__e1535e89ad | stale-reference-to-removed-declaration |
| dius_java-faker__9f0019116a | import-pruning-vs-concurrent-usage |
| elisarver_selophane__4ecc600017 | stale-reference-to-renamed-or-relocated-declaration |
| feroult_yawp__141f79a8e9 | import-pruning-vs-concurrent-usage |
...
| jakewharton_disklrucache__7f28919d2a | changed-behavior-vs-stale-expectation |
...
| jenkinsci_coverity-plugin__62bdb6232e | changed-behavior-vs-stale-expectation |
...
| jnr_jnr-unixsocket__467698b6bd | import-pruning-vs-concurrent-usage |
| joel-costigliola_assertj-core__df351133a9 | import-pruning-vs-concurrent-usage |
| jsprit_jsprit__df2e3e4b7e | changed-behavior-vs-stale-expectation |
| kaazing_k3po__084cc0b426 | duplicate-concurrent-addition |
| kaazing_robot__084cc0b426 | duplicate-concurrent-addition |
| kongchen_swagger-maven-plugin__10c79c6df1 | changed-behavior-vs-stale-expectation |
| logstash_log4j-jsonevent-layout__ee90110799 | import-pruning-vs-concurrent-usage |
| mercadopago_sdk-java__9dfc950fd2 | stale-caller-of-changed-signature |
| mikera_vectorz__d93ef1b341 | import-pruning-vs-concurrent-usage |
| mitre_http-proxy-servlet__b7a68118f2 | stale-caller-of-changed-signature |
| movsim_movsim__6dae25caf7 | import-pruning-vs-concurrent-usage |
| msopentech_azure-activedirectory-library-for-java__d3f143872b | stale-caller-of-changed-signature |
| ninjaframework_ninja__94b2365be3 | import-pruning-vs-concurrent-usage |
...
| sander2798_enderstone__9d0d7b7ba8 | changed-behavior-vs-stale-expectation |
...
| segmentio_analytics-java__0d4a7b4e69 | import-pruning-vs-concurrent-usage |
...
| square_javapoet__d019b6f624 | import-pruning-vs-concurrent-usage |
...
| thenewcircle_spring-hibernate-20120924__7ec9c1b4bb | import-pruning-vs-concurrent-usage |
...
**Category sizes (provisional):** import-pruning-vs-concurrent-usage 15; stale-caller-of-changed-signature 14; stale-reference-to-removed-declaration 9; stale-reference-to-renamed-or-relocated-declaration 7; changed-behavior-vs-stale-expectation 5; overlapping-edit-interleaving 5; duplicate-concurrent-addition 3; insertion-anchored-to-relocated-code 2; residual-other 0. No category rests on a single unit, so none is flagged `provisional`.